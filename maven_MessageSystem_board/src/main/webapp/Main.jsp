	...
	<div id="wrapper">
		...
		<ul class="actions vertical">
			...
			<form action="joinService.do" method="post">
				<li><input type="text" placeholder="Email을 입력하세요" name="email"></li>
				<li><button type="button" id="btn">아이디 중복확인</button></li>
		...
		<div class="inner">
			...
			<!-- ex) smhrd님 환영합니다.  --> <%if(login == null){ %>
			<h1>로그인 한 세션아이디를 출력해주세요</h1>
			<%}else{ %>
			<h1><%=login.getEmail() %>님 환영합니다.
			</h1>
			<%} %> </header>
			<div class="content">
				<p>
    ...
    <script type="text/javascript">
        ...
        $('#btn').on('click', function(){
        	...
        	$.ajax({
        		...
        		// type : "get",/* 어떤 방식으로 보낼지?  get은 생략해두됌*/
