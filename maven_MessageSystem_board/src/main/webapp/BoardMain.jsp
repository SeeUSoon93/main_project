...
<body>		
			...
			List<BoardVO> board_list = dao.showBoard();%>
			...
			<div id="board">
		      ...
		      <%for(int i =0; i<board_list.size();i++) {%>
					<tr>
						<td><%=board_list.get(i).getNum() %></td>
					    <td>
					       <a href="BoardDetail.jsp?num=<%=board_list.get(i).getNum()%>">
					           <%=board_list.get(i).getTitle() %>
					       </a>
					    </td>
					    <td><%=board_list.get(i).getWriter() %></td>
					    <td><%=board_list.get(i).getB_date() %></td>
					    <td><a href="boardDelete.do?num=<%=board_list.get(i).getNum()%>">삭제</a></td>
				   </tr>
              <%} %>
				</table>
