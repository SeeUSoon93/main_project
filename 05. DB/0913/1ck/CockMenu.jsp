		...
		<div class="CateAndRecipe">
			<div class="categoryBox1">
				<div class="categoryBox2">
					...
					<div class="menubox1">
						<input type="checkbox" name="base" value="">보드카<br> <input
							type="checkbox" name="base" value="">진<br> <input
							type="checkbox" name="base" value="">위스키<br> <input
							type="checkbox" name="base" value="">럼<br> <input
							type="checkbox" name="base" value="">데킬라<br>
					</div>

					<div class="ingredient">재 료 ▼</div>
					<div class="menubox2">
						<input type="checkbox" name="base" value=""> 시럽<br> <input
							type="checkbox" name="base" value=""> 주스<br> <input
							type="checkbox" name="base" value=""> 탄산수<br> <input
							type="checkbox" name="base" value=""> 토닉워터<br> <input
							type="checkbox" name="base" value=""> 에너지드링크
					</div>
					...
					<div class="cocktailsBox">
						...
						<div class="recipe">
							...
							<div class="recipetitle">
								...
								<div class="recipename2">❤<%=like.get(i).getLike() %> 🏷 50 🗨 30</div>
							</div>
