			...
			<div class="categoryBox1">
				<div class="categoryBox2">
					...
					<div class="menubox1">
						...
						<input type="checkbox" name="base" value="진" onclick="getCheckboxValue()"/>진<br> <input
							type="checkbox" name="base" value="위스키" onclick="getCheckboxValue()"/>위스키<br> <input
							type="checkbox" name="base" value="럼" onclick="getCheckboxValue()"/>럼<br> <input
							type="checkbox" name="base" value="데킬라" onclick="getCheckboxValue()"/>데킬라<br>
					</div>
					...
					<div class="menubox3">
						<input type="checkbox" name="dosu" value="10" onclick="getCheckboxValue()"> 0%대<br>
						<input type="checkbox" name="dosu" value="20" onclick="getCheckboxValue()"> 10%대<br>
						<input type="checkbox" name="dosu" value="30" onclick="getCheckboxValue()"> 20%대<br>
						<input type="checkbox" name="dosu" value="40" onclick="getCheckboxValue()"> 30%대<br>
				...
				// 초기에 선택된 체크박스 값을 저장할 변수들
					...
					var dosuValues = [];
					  ...
					  const ingredientQuery = 'input[name="ingredient"]:checked';
					  const dosuQuery = 'input[name="dosu"]:checked';
					  					  
					  const selectedBase = document.querySelectorAll(baseQuery);
					  const selectedIngredient = document.querySelectorAll(ingredientQuery);
					  ...
					  // 선택된 목록에서 ingredient 찾기					  
					  selectedIngredient.forEach((ingredient) => {
						  ingredientValues.push(ingredient.value);
					  });	
					  // 선택된 목록에서 base 찾기					  
