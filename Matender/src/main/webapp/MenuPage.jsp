...
<body>
	...
	<div class="Menugroup">
		...
		<div class="contents">
			...
			<div class="textbox">
				<h4 class="text">블루하와이 칵테일에 코코넛 크림이 들어가있습니다.</h4>
			</div>
			...
			<div class="likebox">
				<h4 class="like">
					<img src="./img/like.png" width="20px" height="20px"> 30
					<img src="./img/bookmark.png" width="20px" height="20px"> 50
	...
	<div class="Group">
		...
		<div class="info">
				...
				<div class="display">
					...
					<div class="metname">
						<h3 class="metinfo1">
							...
							얼음<br> 레몬<br> 마라스키노 체리<br> 파인애플<br> 파인애플 주스<br>
							설탕 시럽<br> 블루 큐라소<br> 보드카<br> 화이트 럼<br>

						</h3>
					</div>
					<div class="amount">
						<h3 class="metinfo2">
							200gram<br> 15ml<br> 1개<br> 1wedge<br> 90ml<br>
							15ml<br> 15ml<br> 20ml<br> 20ml<br>
			...
			<div class="method">
				<h3 class="methinfo">
					1. 셰이커에 얼음을 채운다. <br> 2. 화이트 럼 20ml, 보드카 20ml, 블루 큐라소 15ml를
					넣는다. <br> 3. 파인애플 주스 90ml, 레몬 주스 15ml, 설탕 시럽 15ml를 넣는다. <br>
					4. 원하는 만큼 흔들거나 저어 허리케인 글라스에 붓는다. <br> 5. 마라스키노 체리 또는 파인애플 조각으로
					장식한다. <br>
				</h3>
